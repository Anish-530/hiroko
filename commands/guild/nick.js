...
module.exports={
    ...
    run: async(bot, message, args)=>{
        ...
        if(!message.member.hasPermission("ADMINISTRATOR", "MANAGE_NCIKNAMES", "CHANGE_NICKNAMES")) return message.reply("Sorry, Your roles are too low to use this command :(");
        if(!message.member.guild.me.hasPermission("ADMINISTRATOR", "MANAGE_NCIKNAMES", "CHANGE_NICKNAMES")) return message.reply("I don't have the permission to change nicknames :(");
        ...
        if(uuser === message.author) return message.channel.send("You can change your name manually, you know?")

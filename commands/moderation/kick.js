...
module.exports={
    ...
    run: async(bot, message, args)=>{
        ...
        if (!args[0]) return message.reply('You need to Mention whom you want to kick :) . Ex: \`hey kick @someone\` or \`hey kick User-ID\`').then(message => message.delete({ timeout: 10000 }));
